            ...
            <div class="carousel-inner">
              <div class="carousel-item active" data-bs-interval="6000">
                <img
                  ...
                  class="d-block w-100"
                  alt="imagen de fruto del cacao"
                />
              </div>
              <div class="carousel-item" data-bs-interval="6000">
                <img
                  src="<?php echo get_template_directory_uri();?>/assets/images/banner2.jpg"
                  class="d-block w-100"
          ...
          <div class="section-inner container">
            ...
            <div class="section-products__gallery flex">
              <div class="gallery__item">
                <div class="item">
                  <img
                    ...
                    src="<?php echo get_template_directory_uri();?>/assets/images/Ankoa65.jpg"
                    alt="ankoa barra al 65%"
                  />
              ...
              <div class="gallery__item">
                <img
                  class="gallery__image"
                  src="<?php echo get_template_directory_uri();?>/assets/images/Ankoa75.jpg"
                  alt="ankoa barra al 75%"
                />
                <p class="gallery__tag">
              ...
              <div class="gallery__item">
                <img
                  class="gallery__image"
                  src="<?php echo get_template_directory_uri();?>/assets/images/Ankoa85.jpg"
                  alt="ankoa barra al 85%"
                />
                <p class="gallery__tag">
        ...
        <div class="section-inner grid">
            ...
            <div class="section-mission__content section-column flex-reverse">
                <div class="mission__content">
                  ...
                  <h2 data-aos="fade-right" data-aos-easing="ease-in" data-aos-duration="500">VISIÓN</h2>
                  <p>
                    Proyectándonos como uno de los mayores exportadores de
                    chocolate Ecuatoriano con un alto nivel de calidad con
                    productos nobles de la naturaleza y cuidando el medio
                    ambiente.
                  </p>
                </div>
            </div>
