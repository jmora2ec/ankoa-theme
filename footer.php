...
<footer>
  <div class="footer">
    <div class="footer-wrap">
      <div class="container">
        <div class="primary-footer grid">
          <div class="footer-section accordion company">
            <div class="accordion-heading"><h3>ANKOA</h3></div>
            <div class="accordion-panel">
              Nuestro cacao es plantado <br />y procesado por manos
              <br />ecuatorianas, para llevar una <br />experiencia
              excepcional a tu <br />paladar.
            </div>
          </div>
